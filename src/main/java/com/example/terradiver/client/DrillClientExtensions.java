...
public class DrillClientExtensions {
    ...
    // Высота бура над головой (мировые блоки, до масштабирования). Финал: -2 пикселя от исходных 0.4
    // (0.4 - 0.125 = 0.275). Шаг подстройки: 1px = 0.0625. - TUNE
    private static final double ABOVE_HEAD = 0.275D; // - TUNE (было 0.4; -0.125 = -2px, финал)
